...
--Consultando itens da tabela EMPLOYEES(Funcionários)
SELECT * FROM EMPLOYEES;

--Inserindo multiplos registros na tabela EMPLOYEES(Funcionários)
INSERT INTO  EMPLOYEES(NAME, PHONE, CONTRACT_DATE, POSITION_ID)
                 VALUES('Adriana Lemes','(11) 98789-9999','10/04/2021',1),
                       ...
                       ('Aline Santos','(11) 99789-3135','06/05/202',3); --* ANO FALTANDO 1 DIGITO!
